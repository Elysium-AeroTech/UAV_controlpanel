    ...
    <div className="space-y-6">
      <Tabs defaultValue="upload" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="upload">Upload Scripts</TabsTrigger>
          <TabsTrigger value="execute" disabled={!allFiles}>
            Execute Scripts
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="execute" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Play className="h-5 w-5" /> Execute Python Scripts
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {message && (
                      ...
                      <div className="space-y-2">
                        {filesByPage[page].map((file) => (
                          ...
                          >
                            ...
                            <Button
                              size="sm"
                              onClick={() => handleRunScript(file.filename)}
                              disabled={isRunning}
                              className="gap-2"
                            >
              ...
              {executionOutput && (
                <Card className="bg-secondary/50">
                  ...
                  <CardContent>
                    <pre className="bg-background p-3 rounded text-xs overflow-auto max-h-64 font-mono">
                      {executionOutput}
                    </pre>
                  </CardContent>
                </Card>

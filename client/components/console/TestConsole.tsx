        ...
        <div className="p-4 grid md:grid-cols-2 gap-6">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="twoperson"
                checked={requireTwoPerson}
                onCheckedChange={setRequireTwoPerson}
              />
            </div>
            <p className="text-xs text-muted-foreground">
              Turn off to bypass Prerit & Raghav codes (for testing only).
            </p>
            <Separator />
            <div>
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              Use this console to simulate data streams and bypass two-person
              consent for testing only.
            </p>
            <ul className="list-disc list-inside">
              <li>Toggle two-person consent requirement</li>
              <li>
                Inject telemetry values (RPM, Battery, Speed, Temp, Altitude)
              </li>
